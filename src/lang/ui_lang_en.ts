...
const controller_lang_en:ControllerUiLangClassList					=
{
	...
	[ControllerUiLangClassId.MESSAGE_UPDATE_START_BOOTLOADER]: "Start update bootloader",
	...
	[ControllerUiLangClassId.MIGRATION_LEARN_INFO_EXLUDE_INCLUDE]: "learn include/exlude",
	[ControllerUiLangClassId.MIGRATION_FILED_DETECT]: "could not be detected",
	[ControllerUiLangClassId.MIGRATION_PROCESS_QUEST_INCLUDE]: "<div>Please turn on include mode on you controller</div><div>When inclusion start you have to select all the supported keys and use:<b>${dsk}</b></div>",
